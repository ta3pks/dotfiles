...
nnoremap <buffer> \t : call <SID>RUST_RUN("test --workspace ".g:rust_test_params." -- --nocapture --test-threads=1")<cr>
nnoremap <buffer> \tc :call <SID>RUST_RUN("test ".expand("<cword>")." -- --nocapture  --test-threads=1")<cr>
nnoremap <buffer> \ti :call <SID>RUST_RUN("test ".input("name of the test fn: ")." -- --nocapture --test-threads=1")<cr>
