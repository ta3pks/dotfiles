...
local keymaps = {
	...
	["Q"]            = ":try | close | catch | bprevious | endtry<cr>",
	["<c-a-f>"]      = ":lua require('plugins.openterm').open_full_term('ranger',false)<cr>",
	["<a-f>"]        = ":lua require('plugins.openterm').open_full_term('ranger',true)<cr>",
