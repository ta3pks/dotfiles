...
Reference full template: `/home/nikos/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/nikos/.config/opencode/get-shit-done/templates/state.md`.
