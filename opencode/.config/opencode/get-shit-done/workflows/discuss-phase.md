...
```bash
node /home/nikos/.config/opencode/get-shit-done/bin/gsd-tools.cjs commit "docs(${padded_phase}): capture phase context" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
...
```bash
node /home/nikos/.config/opencode/get-shit-done/bin/gsd-tools.cjs commit "docs(state): record phase ${PHASE} context session" --files .planning/STATE.md
```
</step>
...
Task(
  prompt="
    ...
    <execution_context>
    @/home/nikos/.config/opencode/get-shit-done/workflows/plan-phase.md
    @/home/nikos/.config/opencode/get-shit-done/references/ui-brand.md
