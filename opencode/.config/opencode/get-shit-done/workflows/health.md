...
```bash
node /home/nikos/.config/opencode/get-shit-done/bin/gsd-tools.cjs validate health $REPAIR_FLAG
```
...
```bash
node /home/nikos/.config/opencode/get-shit-done/bin/gsd-tools.cjs validate health
```
