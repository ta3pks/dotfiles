...
```
Task(
  prompt="Read /home/nikos/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/nikos/.config/opencode/get-shit-done/templates/VALIDATION.md`
